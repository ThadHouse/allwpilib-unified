...
Welcome to the WPILib project. This repository contains the wpiutil, cscore, ntcore, cameraserver, HAL, WPILibJ, and WPILibC projects. These are the core libraries for creating robot programs for the roboRIO.
...
- A C++ compiler
    ...
    - On Windows, you need Visual Studio 2015 or Visual Studio 2017 (the free community edition works fine).
